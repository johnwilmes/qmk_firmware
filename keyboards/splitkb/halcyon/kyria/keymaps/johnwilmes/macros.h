...
#define EACH_COMBO_DEF()\
    ...
    COMBO_DEF(TAB2, KC_TAB, L_THUMB_O1, L_INDEX_D, L_INDEX_OD)\
    COMBO_DEF(ENTER2, KC_ENTER, L_THUMB_O1, L_INDEX_H, L_INDEX_O)\
    COMBO_DEF(DELETE, KC_DELETE, R_THUMB_H, R_INDEX_D, R_INDEX_OD)\
    COMBO_DEF(ESCAPE, KC_ESCAPE, R_THUMB_H, R_INDEX_H, R_INDEX_O)\
    COMBO_DEF(DELETE2, KC_DELETE, R_THUMB_O1, R_INDEX_D, R_INDEX_OD)\
    COMBO_DEF(ESCAPE2, KC_ESCAPE, R_THUMB_O1, R_INDEX_H, R_INDEX_O)\
