...
#define EACH_PRECOG_DEF()\
    ...
    PRECOG_HOMO_DEF(THUMB_O2, PINKY_H)\
    PRECOG_HOMO_DEF(THUMB_O2, RING_H)\
    PRECOG_HOMO_DEF(THUMB_O2, MIDDLE_H)\
    PRECOG_HOMO_DEF(THUMB_O2, INDEX_H)\
    PRECOG_HETERO_DEF(THUMB_O2, THUMB_H)

#define EACH_COMBO_DEF()\
    EACH_PRECOG_DEF()\
    COMBO_DEF(TAB, KC_TAB, L_INDEX_H, L_INDEX_O)\
    COMBO_DEF(ENTER, KC_ENTER, L_INDEX_D, L_INDEX_OD)\
    COMBO_DEF(DASH, MY_DASH, L_RING_U, L_MIDDLE_U, L_INDEX_U)\
    COMBO_DEF(UNDERSCORE, MY_LINE, L_RING_D, L_MIDDLE_D, L_INDEX_D)\
    COMBO_DEF(BSLASH, MY_BACKSLASH, R_RING_U, R_MIDDLE_U, R_INDEX_U)\
    COMBO_DEF(SLASH, MY_SLASH, R_RING_D, R_MIDDLE_D, R_INDEX_D)\
    COMBO_DEF(ESCAPE, KC_ESCAPE, R_INDEX_H, R_INDEX_O)\
    COMBO_DEF(DELETE, KC_DELETE, R_INDEX_D, R_INDEX_OD)\
